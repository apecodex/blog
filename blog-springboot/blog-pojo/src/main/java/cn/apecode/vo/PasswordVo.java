...
@NoArgsConstructor
@Builder
@ApiModel(value = "更新密码", description = "前端输入新的密码更新密码")
public class PasswordVo {

    @NotBlank(message = "旧密码不能为空")
    @ApiModelProperty(value = "旧密码", name = "oldPassword", required = true, dataType = "String")
    ...
    @ApiModelProperty(value = "验证码", name = "code", required = true, dataType = "String")
    private String code;
